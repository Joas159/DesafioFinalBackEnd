...
const registerCustomer = async (req, res) => {
    const { name, email, phone, street, number, sector, city, state, cpf:cpfNumber, zipcode, complement } = req.body;
    ...
    try {
        ...
        if (cpfReal === true){
            ...
            const regCustomerCpf = await connection.query(queryRegCustomerCpf, [cpfNumber]);
